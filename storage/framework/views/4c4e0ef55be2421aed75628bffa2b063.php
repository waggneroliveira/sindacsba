    ...
    <section class="juridico mb-5">
        <div class="container">
            ...
            <div id="juridicoResults">
                <?php echo $__env->make('client.ajax.juridico-ajax', ['juridicos' => $juridicos], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </section>
...
<script>
    ...
    function loadResults() {
        $.ajax({
            url: "<?php echo e(route('search-juridico')); ?>",
            type: "GET",
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/blades/juridico.blade.php ENDPATH**/ ?>