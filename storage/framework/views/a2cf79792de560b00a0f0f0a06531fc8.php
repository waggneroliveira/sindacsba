...
<?php if(!empty($slides) && $slides->count() > 0): ?>
                ...
                <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <picture class="d-flex">
                            <source srcset="<?php echo e(asset('storage/' . $slide->path_image_mobile)); ?>" media="(max-width: 885px)">
                            <img src="<?php echo e(asset('storage/' . $slide->path_image)); ?>" alt="Banner Hero" title="Banner Hero" class="image-hero w-100">
                        </picture>
                        <div class="w-100 d-flex justify-content-center flex-column align-items-center position-absolute description" style="z-index: 6;">
                            <div class="max-width container">
                                <h1 class="text-white mb-2 rethink-sans-bold"><?php echo $slide->title; ?></h1>
                                <div class="description text-white mb-5 montserrat-regular d-flex no-wrap align-items-center">
                                    <?php echo $slide->description; ?>

                                </div>
                                <?php if(!empty($slide->link)): ?>
                                    <a href="<?php echo e($slide->link); ?>" target=_blank rel="noopener noreferrer" class="montserrat-medium font-15 px-3 rounded-5 col-12 col-lg-2 py-2 text-white background-red d-flex justify-content-center align-items-center">
                                    Saiba mais
                                    </a>
                                <?php endif; ?>
                            </div>
...
<?php if(isset($topics) && $topics->count() > 0): ?>
            ...
            <div class="row g-3 justify-content-center">
                <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                    <div class="col-12 col-sm-4 col-md-2 d-flex justify-content-center position-relative">
                        <?php if(isset($topic->link) && $topic->link <> null): ?>                            
                            <a href="<?php echo e($topic->link); ?>" class="position-absolute top-0 left-0 w-100 h-100" rel="noopener noreferrer"></a>
                        <?php endif; ?>
                        <div class="partner-card <?php echo e(isset($topics) ? $topic->color : 'dark-background'); ?> border rounded-2 d-flex flex-column justify-content-center align-items-start gap-3 p-3 w-100">
                            <?php if($topic->path_image <> null): ?>                                
                                <img src="<?php echo e(asset('storage/' . $topic->path_image)); ?>" 
                                    alt="Logo do parceiro" 
                                    class="img-fluid" 
                                    loading="lazy"/>
                            <?php endif; ?>
                            <h2 class="montserrat-bold montserrat-bold font-18  mb-0 title-blue text-uppercase mb-0 text-white"><?php echo e($topic->title); ?></h2>                            
                        </div>                        
                    </div>                                      
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php if(isset($blogSuperHighlights) && $blogSuperHighlights <> null): ?>
...
<?php if(isset($about) && $about <> null || isset($partners) && $partners->count() > 0): ?>
                ...
                <div id="about-1" class="d-flex justify-content-between align-items-start about flex-wrap w-100 pt-3 pb-3 pt-lg-5">
                    <div class="col-12 col-lg-7 animate-on-scroll" data-animation="animate__fadeInLeft">
                        <div class="border-bottom mb-0">
                            <h2 class="section-title rounded-top-left d-table px-4 w-auto m-0 montserrat-bold font-18 title-blue"><?php echo e($about->title); ?></h2>
                        </div>
                        ...
                        <div class="btn-about my-4">
                            <a href="<?php echo e(route('about')); ?>#<?php echo e($about->slug); ?>" class="background-red montserrat-semiBold font-15 py-2 px-4 rounded-4">Saiba mais</a>
                        </div>
                    </div>
                    <div class="col-11 col-lg-4 animate-on-scroll mb-3" data-animation="animate__fadeInRight">
                        <div class="image d-flex justify-content-end">
                            <img src="<?php echo e(asset('storage/' . $about->path_image)); ?>" loading="lazy" alt="About" class="w-100 h-100 about-image d-sm-block" loading="lazy">
                        </div>
                    </div>
                </div>     
            <?php endif; ?>
...
<?php if(!empty($videos) && $videos->count() > 0): ?>
    <section class="video">
                        ...
                        <div class="swiper-wrapper py-4 flex-column align-items-start justify-content-start m-auto position-relative">
                            <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide align-items-center mb-3 justify-content-start"
                                    data-video="<?php echo e($video->link); ?>">
...
<?php if(isset($trendingCategories) && $trendingCategories->count() > 0): ?>
    <section class="category-blog-home py-0 mt-5">
        <div class="container-fluid p-0">
            <div class="row g-3 justify-content-start">
                <?php $__currentLoopData = $trendingCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trendingCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                    <div class="col-6 col-sm-4 col-md-2 d-flex justify-content-center p-0 mt-0">
                        <div class="box-category text-center w-100 position-relative overflow-hidden">
                            <?php if(isset($trendingCategory->path_image) && $trendingCategory->path_image <> null): ?>
                                <img src="<?php echo e(asset('storage/' . $trendingCategory->path_image)); ?>" alt="" class="w-100 img-fluid mx-auto">
                                <?php else: ?>
                                <img src="<?php echo e(asset('build/client/images/category-blog.png')); ?>" alt="" class="w-100 img-fluid mx-auto">
                            <?php endif; ?>
                            <div class="overlay">
                                <a href="<?php echo e(route('blog', ['category' => $trendingCategory->slug])); ?>#news" class="w-100 text-center">
                                    <h4 class="title montserrat-semiBold font-18 text-white mt-2"><?php echo e($trendingCategory->title); ?></h4>
                                </a>
                            </div>
                        </div>
                    </div>
...
<?php if(isset($recentCategories) || isset($events)): ?>
                ...
                <?php if($recentCategories->count() > 0): ?>                    
                    <div class="col-12 col-lg-9 animate-on-scroll mb-3" data-animation="animate__fadeInLeft">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-end">
                                ...
                                <nav class="mt-3 mt-md-0">
                                    <ul class="list-unstyled d-flex flex-row flex-wrap gap-2 gap-md-3 justify-content-start justify-content-md-center mb-0">
                                        ...
                                        <?php $__currentLoopData = $recentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="py-2 px-1 px-sm-3 text-uppercase montserrat-semiBold font-14 text-black">
                                                <a href="javascript:void(0)" class="text-decoration-none text-black category-filter" data-category="<?php echo e($category->slug); ?>">
                        ...
                        <div id="news-container">
                            <?php echo $__env->make('client.ajax.filter-blog-homePage', [
                    ...
                    <div class="col-lg-3" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <div class="bg-white p-3">      
                                    ...
                                    <div class="d-flex align-items-center bg-white mb-3 overflow-hidden" style="height: 80px;">
                                        <div class="date col-4 h-100 d-flex justify-content-center align-items-center flex-column border border-right-1">
                                            ...
                                            <span class="montserrat-medium w-100 h-50 d-flex justify-content-center align-items-center font-14 title-blue background-red text-white">
                                                <?php echo e(ucfirst(\Carbon\Carbon::parse($event->date)->translatedFormat('F'))); ?>

                                            </span>
                                        </div>
                                        <div class="col-8 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                            <?php if($event->link): ?>
                                                <a href="<?php echo e($event->link); ?>" class="underline">
                                            <?php else: ?>
                                                <a href="<?php echo e(route('client.event')); ?>?event_id=<?php echo e($event->id); ?>&scroll=true" class="underline">
                                            <?php endif; ?>
                                                <h3 class="h6 m-0 montserrat-bold font-14 title-blue" title="<?php echo e($event->title); ?>">
                                                    <?php echo e(substr(strip_tags($event->title), 0, 50)); ?>...
                                                </h3>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="btn-about d-table m-auto mt-5">
                                <a href="<?php echo e(route('client.event')); ?>" class="background-red montserrat-semiBold font-18 py-2 px-4 rounded-5">Ver todos</a>
                            </div>                      
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/blades/index.blade.php ENDPATH**/ ?>