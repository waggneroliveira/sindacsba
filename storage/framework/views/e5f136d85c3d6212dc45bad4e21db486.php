...
<html lang="en" data-layout-mode="detached" data-topbar-color="dark" data-sidenav-user="true">
    ...
    <head>
        ...
        <meta name="description" content="Painel gerenciador de conteúdo <?php echo e(env('APP_NAME')); ?>">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-brand">
                                        <a href="" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="<?php echo e(asset('build/admin/images/whi.png')); ?>" alt="" height="22">
                                            </span>
                                        </a>
...
<?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/admin/success/success-logout.blade.php ENDPATH**/ ?>