...
<div class="container">
    <div class="row">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="name_section" class="form-control" id="name_section"
                            value="<?php echo e($contact->name_section ?? ''); ?>" placeholder="Nome da sessão">
                    </div>
                    <div class="col-12 col-md-8">
                        <label for="text" class="form-label">Texto</label>
                        <input type="text" name="text" class="form-control" id="text"
                            value="<?php echo e($contact->text ?? ''); ?>" placeholder="Texto">
                    </div>
                    <div class="col-12">
                        <label for="maps" class="form-label">Link mapa</label>
                        <input type="text" name="maps" class="form-control" id="maps"
                        value="<?php echo e($contact->maps ?? ''); ?>" placeholder="Mapa">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-8">
                        ...
                        <input type="text" name="name_section_social_media" class="form-control" id="name_section_social_media"
                            value="<?php echo e($contact->name_section_social_media ?? ''); ?>" placeholder="Nome da sessão">
                    </div>
                    <div class="col-12 col-md-2">
                        <label for="mention" class="form-label">Menção</label>
                        <input type="text" name="mention" class="form-control" id="mention"
                            value="<?php echo e($contact->mention ?? ''); ?>" placeholder="Menção">
                    </div>
                    <div class="col-12 col-md-2">
                        <label for="whatsapp" class="form-label">Whatsapp</label>
                        <input type="text" name="whatsapp" class="form-control" id="whatsapp"
                            value="<?php echo e($contact->whatsapp ?? ''); ?>" placeholder="Whatsapp">
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="link_insta" class="form-control" id="link_insta"
                            value="<?php echo e($contact->link_insta ?? ''); ?>" placeholder="Link Instagram">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="link_x" class="form-label">Link X</label>
                        <input type="text" name="link_x" class="form-control" id="link_x"
                            value="<?php echo e($contact->link_x ?? ''); ?>" placeholder="Link X">
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="link_youtube" class="form-control" id="link_youtube"
                            value="<?php echo e($contact->link_youtube ?? ''); ?>" placeholder="Link Youtube">
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="link_face" class="form-label">Link Facebook</label>
                        <input type="text" name="link_face" class="form-control" id="link_face"
                            value="<?php echo e($contact->link_face ?? ''); ?>" placeholder="Link Facebook">
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="link_tik_tok" class="form-control" id="link_tik_tok"
                            value="<?php echo e($contact->link_tik_tok ?? ''); ?>" placeholder="Link Tik Tok">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 mb-4">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = ['one', 'two', 'three']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-lg-4">
                        <div class="card card-body h-100">
                            <div class="mb-3">
                                <label for="name_<?php echo e($i); ?>" class="form-label">Nome da filial <?php echo e($i); ?></label>
                                <input type="text" name="name_<?php echo e($i); ?>" class="form-control" id="name_<?php echo e($i); ?>"
                                    value="<?php echo e($contact->{'name_'.$i} ?? ''); ?>" placeholder="Título">
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-12 col-md-7">
                                    <label for="opening_hours_<?php echo e($i); ?>" class="form-label">Horário de funcionamento</label>
                                    <input type="text" name="opening_hours_<?php echo e($i); ?>" class="form-control" id="opening_hours_<?php echo e($i); ?>"
                                        value="<?php echo e($contact->{'opening_hours_'.$i} ?? ''); ?>" placeholder="Horário">
                                </div>
                                <div class="col-12 col-md-5">
                                    <label for="phone_<?php echo e($i); ?>" class="form-label">Telefone</label>
                                    <input type="text" name="phone_<?php echo e($i); ?>" class="form-control" id="phone_<?php echo e($i); ?>"
                                        value="<?php echo e($contact->{'phone_'.$i} ?? ''); ?>" placeholder="Telefone">
                                </div>
                            </div>
                            <div>
                                <label for="address_<?php echo e($i); ?>" class="form-label">Endereço</label>
                                <textarea name="address_<?php echo e($i); ?>" id="address_<?php echo e($i); ?>" placeholder="Texto" class="form-control ckeditor" rows="5"><?php echo $contact->{'address_'.$i} ?? ''; ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/admin/blades/contact/form.blade.php ENDPATH**/ ?>