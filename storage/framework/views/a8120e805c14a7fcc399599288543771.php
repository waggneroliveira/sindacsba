...
<!-- ============================================================== -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active"><?php echo e(__('dashboard.title_dashboard')); ?></li>
                    </ol>
                </div>
                <h4 class="page-title"><?php echo e(__('dashboard.title_dashboard')); ?></h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="row">
                ...
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.slide.index')); ?>">
                                <div class="row">
            ...
            Auth::user()->hasPermissionTo('topicos.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.topic.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('parceiros.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.partner.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('videos.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.video.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
        ...
        <div class="row">
            ...
            Auth::user()->hasPermissionTo('sobre nos.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.about.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('a direcao.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.direction.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('estatuto.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.statute.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
        ...
        <div class="row">
            ...
            Auth::user()->hasPermissionTo('convenios.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.agreement.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('sindicalize-se.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.unionized.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('beneficios.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.benefitTopic.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('denuncie.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.report.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
    ...
    Auth::user()->hasPermissionTo('juridico.visualizar')): ?>
        <div class="row">
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.juridico.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
        ...
        <div class="row">
            ...
            Auth::user()->hasPermissionTo('regionais.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.regional.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('municipios.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.municipality.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
    ...
    Auth::user()->hasPermissionTo('agenda.visualizar')): ?>
        <div class="row">
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.event.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
        ...
        <div class="row">
            ...
            Auth::user()->hasPermissionTo('categorias do noticias.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.blogCategory.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('noticias.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.blog.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
        ...
        <div class="row">
            ...
            Auth::user()->hasPermissionTo('contato.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.contact.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('lead contato.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.formIndex.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            Auth::user()->hasPermissionTo('newsletter.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.newsletter.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
    ...
    Auth::user()->hasPermissionTo('anuncio.visualizar')): ?>
        <div class="row">
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.announcement.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.popUp.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
    ...
    Auth::user()->hasPermissionTo('editais.visualizar')): ?>
        <div class="row">
            ...
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.noticies.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
                                        <i class="avatar-md mdi mdi-file-document font-48 text-muted"></i>
    ...
    <?php endif; ?>
        ...
        Auth::user()->can('email.visualizar')): ?>
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title "><i class="mdi mdi-email-edit"></i> <?php echo e(__('dashboard.setting_smtp')); ?></h4>
                </div>
            </div>
            <div class="col-md-5 col-xl-3">
                <div class="card borda-cx ratio ratio-4x3 border-whi">
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="<?php echo e(route('admin.dashboard.settingEmail.index')); ?>">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="avatar-xl bg-hoom rounded-circle text-center">
                            ...
                            <div class="mt-3 col-12 text-center">
                                <h5 class="text-uppercase text-muted"><?php echo e(__('dashboard.setting_email')); ?></h5>
                            </div>
                        </a>
                    </div>
                </div> <!-- end card-->
    ...
    <div class="row">
        ...
        Auth::user()->can('grupo.visualizar')): ?>
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title "><i class="mdi mdi-security"></i> <?php echo e(__('dashboard.security_and_access_control')); ?></h4>
                </div>
            </div>
            <?php if(Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can('auditoria.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.audit.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
                                ...
                                <div class="mt-3 col-12 text-center">
                                    <h5 class="text-uppercase text-muted"><?php echo e(__('dashboard.audit')); ?></h5>
                                </div>
                            </a>
                        </div>
                    </div> <!-- end card-->
            ...
            <?php if(Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can('grupo.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.group.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
                                ...
                                <div class="mt-3 col-12 text-center">
                                    <h5 class="text-uppercase text-muted"><?php echo e(__('dashboard.group_and_permission')); ?></h5>
                                </div>
                            </a>
                        </div>
                    </div> <!-- end card-->
            ...
            <?php if(Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can('usuario.visualizar')): ?>
                <div class="col-md-5 col-xl-3">
                    <div class="card borda-cx ratio ratio-4x3 border-whi">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(route('admin.dashboard.user.index')); ?>">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="avatar-xl bg-hoom rounded-circle text-center">
                                ...
                                <div class="mt-3 col-12 text-center">
                                    <h5 class="text-uppercase text-muted"><?php echo e(__('dashboard.users')); ?></h5>
                                </div>
                            </a>
                        </div>
                    </div> <!-- end card-->
...
<?php echo $__env->make('admin.core.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>