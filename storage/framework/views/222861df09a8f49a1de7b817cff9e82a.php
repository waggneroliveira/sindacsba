...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item "><a href="<?php echo e(route('admin.dashboard.blog.index')); ?>">Notícias</a></li>
            ...
            <div class="row">
                <form action="<?php echo e(route('admin.dashboard.blog.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input name="active" type="checkbox" class="form-check-input" id="invalidCheck<?php echo e(isset($blog->id)?$blog->id:''); ?>" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                Auth::user()->hasPermissionTo('sobre nos.criar')): ?>
                    <form action="<?php echo e(route('admin.dashboard.event.storeTheBlog')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo $__env->make('admin.blades.event.form', ['textareaId' => 'textarea-create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <div class="d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-dismiss="modal"><?php echo e(__('dashboard.btn_cancel')); ?></button>
                            <button type="submit" class="btn btn-primary text-black waves-effect waves-light"><?php echo e(__('dashboard.btn_create')); ?></button>
                        </div>
...
<?php echo $__env->make('admin.core.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/admin/blades/blog/create.blade.php ENDPATH**/ ?>