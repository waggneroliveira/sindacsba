...
<head>
    ...
    <?php if(isset($blogInner)): ?>
        <meta property="og:url" content="<?php echo e(url()->current()); ?>">
        <meta property="og:type" content="article">
        <meta property="og:title" content="<?php echo e($blogInner->title); ?>">
        <meta property="og:description" content="<?php echo e(Str::limit(strip_tags($blogInner->content), 150)); ?>">
        <meta property="og:image" content="<?php echo e(asset('storage/' . $blogInner->path_image_thumbnail)); ?>">

        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:url" content="<?php echo e(url()->current()); ?>">
        <meta name="twitter:title" content="<?php echo e($blogInner->title); ?>">
        <meta name="twitter:description" content="<?php echo e(Str::limit(strip_tags($blogInner->content), 150)); ?>">
        <meta name="twitter:image" content="<?php echo e(asset('storage/' . $blogInner->path_image_thumbnail)); ?>">
    <?php else: ?>
        <meta property="og:url" content="<?php echo e(url()->current()); ?>">
        ...
        <meta property="og:image" content="<?php echo e(asset('build/client/images/compartilhamento.png')); ?>">
        ...
        <meta name="twitter:image" content="<?php echo e(asset('build/client/images/compartilhamento.png')); ?>">
    <?php endif; ?>
    ...
    <link rel="preload" href="<?php echo e(asset('build/admin/js/libs/sweetalert2/sweetalert2.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="<?php echo e(asset('build/admin/js/libs/sweetalert2/sweetalert2.min.css')); ?>" rel="stylesheet" type="text/css"></noscript>
    <link rel="preload" href="<?php echo e(asset('build/admin/js/libs/dropzone/min/dropzone.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="<?php echo e(asset('build/admin/js/libs/dropzone/min/dropzone.min.css')); ?>" rel="stylesheet" type="text/css"></noscript>
    <link rel="preload" href="<?php echo e(asset('build/admin/js/libs/dropify/css/dropify.min.css')); ?>" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="<?php echo e(asset('build/admin/js/libs/dropify/css/dropify.min.css')); ?>" rel="stylesheet" type="text/css"></noscript>
    <link href="<?php echo e(asset('build/client/lgpd/style.css')); ?>" rel="stylesheet" type="text/css" />

    <link href="<?php echo e(asset('build/client/css/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="preload" href="<?php echo e(asset('build/client/css/bootstrap-icons/bootstrap-icons.css')); ?>" as="style" onload="this.rel='stylesheet'">
    <link href="<?php echo e(asset('build/client/css/style.css')); ?>" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <header id="header" class="w-100 d-flex flex-column position p-0">   
                ...
                <div class="d-flex col-12 col-lg-11 justify-content-end align-items-start wrap-logo-and-login">
                    <div class="logo-img px-0 py-2 rounded-2 d-flex justify-content-start align-items-center w-auto">
                        <a href="<?php echo e(route('index')); ?>">
                            <img src="<?php echo e(asset('build/client/images/sindacsba.png')); ?>" alt="Instituto Baiano de Medicina Desportivao" title="Instituto Baiano de Medicina Desportivao" class="img-fluid">
                        </a>
                    </div>
                    <div class="d-flex justify-content-center align-items-center gap-2 mt-3 login-desktop" style="width: 23%;">                        
                        ...
                        <?php else: ?>
                            ...
                            <div class="image-profile">
                                <picture>
                                    <source srcset="<?php echo e(isset($defaultImage) && $defaultImage <> null ?$defaultImage:asset('build/client/images/user.jpg')); ?>" type="image/svg+xml">
                                    <img src="<?php echo e(isset($defaultImage) && $defaultImage <> null ?$defaultImage:asset('build/client/images/user.jpg')); ?>"
                                        alt="Imagem de Login"
                            ...
                            <div class="d-flex flex-column align-items-start gap-1">
                                <div class="d-flex justify-content-start align-items-center gap-2 lh-0">
                                    ...
                                    <h3 class="m-0 montserrat-medium font-14 text-start"><?php echo e($names = collect(explode(' ', Auth::guard('client')->user()->name))->slice(0, 1)->implode(' ')); ?>!</h3>      
                                    <a class="nav-link waves-effect waves-light" href="#" data-bs-toggle="modal" data-bs-target="#editClientModal-<?php echo e(Auth::guard('client')->user()->id); ?>">
                                        <i class="bi bi-gear font-18"></i>
                                    </a>                 
                                </div>  
                                <a href="<?php echo e(route('client.user.logout')); ?>" class="d-flex justify-content-start align-items-center gap-2 text-decoration-none lh-0">
                ...
                <div class="social-links d-flex justify-content-center align-items-center gap-4 mb-2 mt-3 text-center col-12">
                    <nav class="none site-navigation ul position-relative text-end width-75">
                        <ul class="d-flex flex-row justify-content-start align-items-center gap-4 mb-0 list-unstyled">
                            <li><a href="<?php echo e(route('index')); ?>" class="nav-link montserrat-medium text-center font-18">Home</a></li>                                                   
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sobreNosDropdown">
                                    <?php if(isset($abouts) && $abouts->count() > 0): ?> 
                                        <?php $__currentLoopData = $abouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                        
                                            <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('about')); ?>#<?php echo e($about->slug); ?>"><?php echo e($about->title); ?></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    <?php if(isset($directions) && $directions > 0): ?>                                        
                                        <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('about')); ?>#board">Equipe</a></li>
                                    <?php endif; ?>
                                    <?php if(isset($statute) && $statute > 0): ?>                                        
                                        <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('about')); ?>#statute">Estatuto</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle montserrat-medium text-center font-18" 
                                href="<?php echo e(route('unionized')); ?>" 
                                id="servicosDropdown" 
                                role="button" 
                                data-bs-toggle="dropdown" 
                                aria-expanded="false">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="servicosDropdown">
                                    <?php if(isset($agreement) && $agreement > 0): ?>                                
                                        <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('unionized')); ?>#partnes">Convênios</a></li>
                                    <?php endif; ?>
                                    <?php if(isset($directions) && $directions > 0): ?>                                
                                        <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('unionized')); ?>#benefit">Benefícios</a></li>
                                    <?php endif; ?>
                                    <?php if(isset($report) && $report > 0): ?>                                
                                        <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('unionized')); ?>#complaint">Denuncias</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle montserrat-medium text-center font-18" 
                                href="<?php echo e(route('juridico')); ?>" 
                                id="juridicoDropdown" 
                                role="button" 
                                data-bs-toggle="dropdown" 
                                aria-expanded="false">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="juridicoDropdown">
                                    <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'leis'])); ?>">Leis</a></li>
                                    <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'decretos'])); ?>">Decretos</a></li>
                                    <li><a class="dropdown-item montserrat-medium text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'portaria'])); ?>">Portaria</a></li>
                                </ul>

                            </li>

                            <li><a href="<?php echo e(route('regional')); ?>" class="nav-link montserrat-medium text-center font-18">Regionais</a></li>
                            <li><a href="<?php echo e(route('blog')); ?>" class="nav-link montserrat-medium text-center font-18 <?php echo e(request()->routeIs('blog') ? 'active' : ''); ?> <?php echo e(request()->routeIs('blog-inner') ? 'active' : ''); ?>">Notícias</a></li>
                            <li><a href="<?php echo e(route('noticies')); ?>" class="nav-link montserrat-medium text-center font-18 <?php echo e(request()->routeIs('noticies') ? 'active' : ''); ?>">Editais</a></li>
                            <li><a href="<?php echo e(route('contact')); ?>" class="nav-link montserrat-medium text-center font-18 <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Contato</a></li>
                        </ul>                      
                    </nav>
                    
                    <?php if(isset($benefitTopics) && $benefitTopics > 0): ?>                        
                        <div class="btn-filie-se">
                            <a href="<?php echo e(route('unionized')); ?>#benefit" class="badge badge-primary montserrat-medium font-14 text-uppercase me-2 background-red rounded-4 font-weight-semi-bold py-2 px-3 px-sm-5">Filie-se</a>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="swiper-wrapper">
                                <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <a href="<?php echo e(route('blog', ['category' => $category->slug])); ?>#news"
                                        class="carrossel title-blue montserrat-semiBold font-14 d-inline-block px-2
                                        <?php echo e((request()->routeIs('blog-inner') && isset($blogInner) && $blogInner->category->id === $category->id) ||
        ...
        <?php echo $__env->make('client/includes/lgpd/lgpd', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        
        <?php if(isset($contact) && $contact->whatsapp <> null): ?>
            <?php
            ...
            <a
                href="https://wa.me/55<?php echo e($phone); ?>?text=<?php echo e($mensagem); ?>"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content header-color">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('client.user.authenticate')); ?>" method="POST">
                        <!-- CSRF token (Laravel) -->
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content header-color">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('register-client')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <?php if(Auth::guard('client')->check()): ?>
        ...
        ?>
        <!-- Modal de Edição -->
        <div class="modal fade" id="editClientModal-<?php echo e(Auth::guard('client')->user()->id); ?>" tabindex="-1" aria-labelledby="editClientModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content header-color">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('client.update')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label montserrat-medium font-15">Nome</label>
                                <input type="text" class="form-control montserrat-regular font-15" id="name" name="name" value="<?php echo e(Auth::guard('client')->user()->name); ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="emailRegister" class="form-label montserrat-medium font-15">E-mail</label>
                                <input type="email" class="form-control montserrat-regular font-15" id="emailRegister" name="email" value="<?php echo e(Auth::guard('client')->user()->email); ?>" required>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mt-3">
                                    ...
                                    />
                                    <p class="montserrat-regular text-white font-12 mt-2 mb-0"><?php echo e(__('dashboard.text_img_size')); ?> <b class="text-danger">2 MB</b>.</p>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content header-color">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('client.password.email')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div id="menu-mobile" class="menu-mobile d-flex flex-column justify-content-start align-items-center">
        ...
        <div class="col-10 logo-img px-3 py-2 mb-4 rounded-2 d-flex justify-content-center align-items-center">
            <img src="<?php echo e(asset('build/client/images/logo.svg')); ?>" alt="Instituto Baiano de Medicina Desportivao" title="Instituto Baiano de Medicina Desportivao" class="img-fluid">
        </div>
        <div class="row justify-content-center gap-5">
            <nav class="mt-5">
                <ul class="list-unstyled text-center">
                    <li><a href="<?php echo e(route('index')); ?>" class="nav-link text-white montserrat-regular text-center font-18">Home</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sobreNosDropdown">
                            <?php if(isset($abouts) && $abouts->count() > 0): ?> 
                                <?php $__currentLoopData = $abouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                        
                                    <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('about')); ?>#<?php echo e($about->slug); ?>"><?php echo e($about->title); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>                                
                            <?php if(isset($directions) && $directions > 0): ?>                                        
                                <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('about')); ?>#board">Equipe</a></li>
                            <?php endif; ?>
                            <?php if(isset($statute) && $statute > 0): ?>                                        
                                <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('about')); ?>#statute">Estatuto</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="servicosDropdown">
                            <?php if(isset($agreement) && $agreement > 0): ?>                                
                                <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('unionized')); ?>#partnes">Convênios</a></li>
                            <?php endif; ?>
                            <?php if(isset($directions) && $directions > 0): ?>                                
                                <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('unionized')); ?>#benefit">Benefícios</a></li>
                            <?php endif; ?>
                            <?php if(isset($report) && $report > 0): ?>                                
                                <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('unionized')); ?>#complaint">Denuncias</a></li>
                            <?php endif; ?>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="juridicoDropdown">
                            <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'leis'])); ?>">Leis</a></li>
                            <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'decretos'])); ?>">Decretos</a></li>
                            <li><a class="dropdown-item montserrat-regular text-start font-15" href="<?php echo e(route('juridico', ['legal' => 'portaria'])); ?>">Portaria</a></li>
                        </ul>

                    </li>

                    <li><a href="<?php echo e(route('regional')); ?>" class="nav-link text-white montserrat-regular text-center font-18">Regionais</a></li>
                    <li><a href="<?php echo e(route('blog')); ?>" class=" text-white nav-link montserrat-regular font-18">Notícias</a></li>
                    <li><a href="<?php echo e(route('noticies')); ?>" class=" text-white nav-link montserrat-regular font-18">Editais</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class=" text-white nav-link montserrat-regular font-18">Contato</a></li>
                </ul>
            </nav>
    ...
    <footer id="footer" class="footer position-relative dark-background">
        <div class="container pt-5 pb-3">
            <div class="sitemap mt-2 mb-5 row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 g-3 justify-content-between align-items-center">
                <div class=logo>
                    <img src="<?php echo e(asset('build/client/images/logo-footer.svg')); ?>" alt="WHI - Web de Alta Inovação" title="WHI - Web de Alta Inovação" loading=lazy>
                </div>
                <ul class="list-unstyled text-start">
                        <li class="montserrat-regular font-16 mb-3"><a href="<?php echo e(route('index')); ?>">Home</a></li>
                ...
                <ul class="list-unstyled text-start">
                    <li class="montserrat-regular font-16 mb-3"><a href="<?php echo e(route('regional')); ?>">Regionais</a></li>
                    <li class="montserrat-regular font-16 mb-3"><a href="<?php echo e(route('blog')); ?>">Notícias</a></li>
                    <li class="montserrat-regular font-16 mb-3"><a href="<?php echo e(route('noticies')); ?>">Editais</a></li>
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                ...
                <div class=credits>
                    <a href="https://www.sindacsba.org.br/" target=_blank rel="noopener noreferrer">
                        <img src="<?php echo e(asset('build/client/images/developed.svg')); ?>"  alt="WHI - Web de Alta Inovação" title="WHI - Web de Alta Inovação" loading=lazy>
                    </a>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo e(asset('build/client/css/bootstrap/js/bootstrap.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('build/client/css/typed.js/typed.umd.js')); ?>"></script>
    <script src="<?php echo e(asset('build/client/lgpd/script.js')); ?>"></script>
    <script src="<?php echo e(asset('build/client/js/default.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/core/client.blade.php ENDPATH**/ ?>