            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <article>
                            <h1 class="mb-3 title-blue montserrat-bold font-32 text-uppercase"><?php echo e($blogInner->title); ?></h1>
                            <div class="mb-3 d-flex justify-content-start align-items-center gap-1 flex-wrap">
                                <span class="badge background-red montserrat-semiBold font-12 text-uppercase py-2 px-2 me-2"><?php echo e($blogInner->category->title); ?></span>
                                <p class="text-color mb-0 montserrat-regular font-15"><?php echo e($dataFormatada); ?></p>
                            </div>
                            <img class="border img-fluid w-100 rounded-3 image-inner d-flex justify-content-center align-items-center"
                              src="<?php echo e($blogInner->path_image_thumbnail ? asset('storage/'.$blogInner->path_image_thumbnail) : 'https://placehold.co/600x400?text=Sem+imagem&font=montserrat'); ?>"
                              alt="<?php echo e($blogInner->title ? $blogInner->title : 'Sem imagem'); ?>"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="<?php echo e(route('blog')); ?>" class="montserrat-semiBold font-16 d-flex justify-content-between align-items-center gap-2 background-red py-2 px-3 text-white rounded-3">
                            ...
                            <div class="position-relative d-flex justify-content-center align-items-end flex-column">
                                ...
                                <div id="socialLinks" class="socialLinks mt-2 opacity-0">
                                    <div class="d-flex gap-2">
                                        <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($blogInner->title . ' ' . url()->current())); ?>" target="_blank" class="rounded-circle btn btn-sm bg-whatsapp"><i class="fab fa-whatsapp text-white"></i></a>    
                                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($blogInner->title)); ?>" target="_blank" class="rounded-circle btn btn-sm btn-twiter"><i class="fab fa-x-twitter text-white"></i></a>
                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="rounded-circle btn btn-facebook btn-sm"><i class="fab fa-facebook-f text-white"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-0 mt-5">
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <form id="commentForm">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="blog_id" value="<?php echo e($blogInner->id); ?>">
                    ...
                    <!-- Comment List Start -->
                    <?php if(isset($blogInner->comments) && $blogInner->comments->count() > 0): ?>                        
                        <div class="mb-3 mt-3 comments">
                            <div class="section-title mb-0 title-blue rounded-top-left">
                                <h4 class="m-0 text-uppercase montserrat-bold font-25 title-blue"><?php echo e($blogInner->comments->count()); ?> Comentários</h4>
                            </div>
                            <div class="bg-white border border-top-0 p-4 comment-scroll">
                                <?php $__currentLoopData = $blogInner->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        \Carbon\Carbon::setLocale('pt_BR');
                                    ...
                                    <?php if($client): ?>
                                        <div class="d-flex gap-2 flex-column mb-4">
                                            <div class="d-flex mb-0 gap-3">
                                                <img src="<?php echo e($client->path_image_thumbnail ? url($client->path_image_thumbnail) : asset('build/client/images/user.jpg')); ?>"
                     ...
                     <!-- Tags Start -->
                              ...
                              <div class="d-flex flex-wrap m-n1">
                                  <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-link">
                                        ...
                                        <?php echo e((request()->routeIs('blog-inner') && isset($blogInner) && $blogInner->category->id === $category->id) ? 'active background-red' : ''); ?>">
                      ...
                      <?php if($blogRelacionados): ?>                        
                        ...
                        <div class="mb-3">
                            ...
                            <div class="bg-white border border-top-0 p-3">
                                <?php $__currentLoopData = $blogRelacionados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relacionado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                    <?php
                                        \Carbon\Carbon::setLocale('pt_BR');
                                    ...
                                    <article>
                                        <div class="d-flex align-items-center bg-white mb-3 overflow-hidden" style="height: 110px;">
                                            ...
                                            src="<?php echo e($relacionado->path_image_thumbnail_thumbnail ? asset('storage/'.$relacionado->path_image_thumbnail_thumbnail) : 'https://placehold.co/600x400?text=Sem+imagem&font=montserrat'); ?>"
                                            alt="<?php echo e($relacionado->title ? $blogInner->title : 'Sem imagem'); ?>">
                                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                                <div class="mb-2 d-flex justify-content-start align-items-center gap-1 flex-wrap">
                                                    <span class="badge badge-primary montserrat-semiBold font-10 text-uppercase py-1 px-2 mr-2 background-red"><?php echo e($relacionado->category->title); ?></span>
                                                    <p class="text-color mb-0 montserrat-regular font-12"><?php echo e($dataFormatada); ?></p>
                                                </div>
                                                <a href="<?php echo e(route('blog-inner', ['slug' => $relacionado->slug])); ?>" class="underline">
                                                    <h3 class="h6 m-0 text-uppercase montserrat-bold font-14 title-blue"><?php echo e($relacionado->title); ?></h3>
                                                </a>
                                            </div>
                                        </div>
                                    </article>
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/blades/blog-inner.blade.php ENDPATH**/ ?>