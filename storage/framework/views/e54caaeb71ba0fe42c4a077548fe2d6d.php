<div class="row g-3 mt-3">
    <?php $__empty_1 = true; $__currentLoopData = $juridicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $juridico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 box-notices">                        
            <div class="section-title rounded-top-left rounded-3 d-flex flex-column justify-content-start align-items-start h-100">
                <div>
                    <h6 class="mb-1 montserrat-bold font-15 title-blue text-uppercase"><?php echo e($juridico->title); ?></h6>
                    <p class="text-muted text-color montserrat-regular font-15 title-blue"><?php echo e($juridico->description); ?></p>
                </div>

                <div class="d-flex justify-content-between align-items-center w-100">
                    <?php if($juridico->link): ?>                                  
                        <a href="<?php echo e($juridico->link); ?>" target="_blank" 
                    ...
                    <?php if($juridico->path_file): ?>                                    
                        <a href="<?php echo e(asset('storage/' . $juridico->path_file)); ?>" target="_blank"
...
<?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/ajax/juridico-ajax.blade.php ENDPATH**/ ?>