<?php $__env->startSection('content'); ?>
    <section class="notices mb-5">
        ...
        <div class="container py-4">
            ...
            <?php if($groupedNoticies->count()): ?>                
                <h1 class="montserrat-bold font-30 mb-2 title-blue">EDITAIS PUBLICADOS</h1>

                <?php $__currentLoopData = $groupedNoticies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year => $noticies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>           
                    <h5 class="montserrat-bold font-28 mt-5 title-blue"><?php echo e($year); ?></h5>

                    <div class="row g-4 mt-3">
                        <?php $__currentLoopData = $noticies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                            <?php
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3 box-notices">                        
                                <div class="section-title rounded-top-left rounded-3 d-flex justify-content-between align-items-center h-100">
                                    <div>
                                        <h6 class="mb-1 montserrat-bold font-15 title-blue text-uppercase"><?php echo e($noticia->title); ?></h6>
                                        <small class="text-muted text-color montserrat-regular font-16 title-blue"><?php echo e($dataFormatada); ?></small>
                                    </div>

                                    <a href="<?php echo e(asset('storage/'.$noticia->path_file)); ?>" class="text-decoration-none" download="download">
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/blades/notices.blade.php ENDPATH**/ ?>