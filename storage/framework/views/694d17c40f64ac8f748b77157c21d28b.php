...
<div id="loading-indicator"
    ...
    <div class="row">
        <img id="load" src="<?php echo e(asset('build/admin/images/whi-green-horizontal.png')); ?>" alt="Sincronizando suas preferências..." />
        <?php
            $locales = [
        ...
        <?php if(array_key_exists($locale, $locales)): ?>
            <h4><?php echo e($locales[$locale]); ?></h4>    
        <?php else: ?>      
            <h4><?php echo e(__('dashboard.message_sinc_load')); ?></h4>
        <?php endif; ?>
    </div>
</div><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/admin/loadPage/loading.blade.php ENDPATH**/ ?>