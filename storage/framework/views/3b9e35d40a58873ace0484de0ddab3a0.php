<?php $__env->startSection('content'); ?>
    <section class="contact mb-0 mt-4">
        <?php if(isset($contact) && $contact->name_section != null): ?>
            <div class="d-flex justify-content-start gap-2 align-items-start flex-nowrap">
                <span class="firula-contact mt-2"></span>
                <div class="description">
                    <h3 class="montserrat-bold font-30 mb-0 title-blue"><?php echo e($contact->name_section); ?></h3>
                    <p class="mb-0 text-color montserrat-regular font-15"><?php echo e($contact->text); ?></p>
                </div>
            </div>
        <?php endif; ?>
        <div class="container py-5">
            ...
            <div class="row g-3 mb-4">
                <?php if(isset($contact) && $contact->name_one != null ||
                    ...
                    <div class="col-md-4">
                        <div class="border rounded p-3 h-100 bg-box-contact">
                            <?php if(isset($contact) && $contact->name_one != null): ?>                            
                                <div class="d-flex gap-2 justify-content-start align-items-center">
                                    ...
                                    <h6 class="montserrat-semiBold font-18 mb-2 title-blue">
                                        <?php echo e($contact->name_one); ?>

                                    </h6>
                                </div>
                            <?php endif; ?>
                            <?php if(isset($contact) && $contact->address_one != null): ?>                            
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <?php if(isset($contact) && $contact->opening_hours_one != null): ?>  
                                    <p class="mb-1 text-color montserrat-regular font-14 small col-12 col-lg-5"><?php echo e($contact->opening_hours_one); ?></p>
                                <?php endif; ?>
                                <?php if(isset($contact) && $contact->phone_one != null): ?>                                
                ...
                <?php endif; ?>
                <?php if(isset($contact) && $contact->name_two != null ||
                        ...
                        <div class="border rounded p-3 h-100 bg-box-contact">
                            <?php if(isset($contact) && $contact->name_two != null): ?>                            
                                <div class="d-flex gap-2 justify-content-start align-items-center">
                                    ...
                                    <h6 class="montserrat-semiBold font-18 mb-2 title-blue">
                                        <?php echo e($contact->name_two); ?>

                                    </h6>
                                </div>
                            <?php endif; ?>
                            <?php if(isset($contact) && $contact->address_two != null): ?>                            
                                <div class="my-2 text-address">
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                <?php if(isset($contact) && $contact->opening_hours_one != null): ?>  
                                    <p class="mb-1 text-color montserrat-regular font-14 small col-12 col-lg-5"><?php echo e($contact->opening_hours_two); ?></p>
                                <?php endif; ?>
                                <?php if(isset($contact) && $contact->phone_two != null): ?>                                
                                    <p class="mb-0 text-color montserrat-regular font-14 small">
                                        <svg width="13" height="22" viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11 17H2V3H11M6.5 21C6.10218 21 5.72064 20.842 5.43934 20.5607C5.15804 20.2794 5 19.8978 5 19.5C5 19.1022 5.15804 18.7206 5.43934 18.4393C5.72064 18.158 6.10218 18 6.5 18C6.89782 18 7.27936 18.158 7.56066 18.4393C7.84196 18.7206 8 19.1022 8 19.5C8 19.8978 7.84196 20.2794 7.56066 20.5607C7.27936 20.842 6.89782 21 6.5 21ZM10.5 0H2.5C1.83696 0 1.20107 0.263392 0.732233 0.732233C0.263392 1.20107 0 1.83696 0 2.5V19.5C0 20.163 0.263392 20.7989 0.732233 21.2678C1.20107 21.7366 1.83696 22 2.5 22H10.5C11.163 22 11.7989 21.7366 12.2678 21.2678C12.7366 20.7989 13 20.163 13 19.5V2.5C13 1.83696 12.7366 1.20107 12.2678 0.732233C11.7989 0.263392 11.163 0 10.5 0Z" fill="#2F368B"/>
                                        </svg>
            
                                        <?php echo e($contact->phone_two); ?>
                ...
                <?php endif; ?>
                <?php if(isset($contact) && $contact->name_three != null ||
                        ...
                        <div class="border rounded p-3 h-100 bg-box-contact">
                            <?php if(isset($contact) && $contact->name_three != null): ?>                            
                                <div class="d-flex gap-2 justify-content-start align-items-center">
                                    ...
                                    <h6 class="montserrat-semiBold font-18 mb-2 title-blue">
                                        <?php echo e($contact->name_three); ?>

                                    </h6>
                                </div>
                            <?php endif; ?>
                            <?php if(isset($contact) && $contact->address_three != null): ?>                            
                                <div class="my-2 text-address">
                                    <?php echo $contact->address_three; ?>

                                </div>
                            <?php endif; ?>
                            <div class="d-flex justify-content-between flex-wrap">
                                <?php if(isset($contact) && $contact->opening_hours_one != null): ?>  
                                    <p class="mb-1 text-color montserrat-regular font-14 small col-12 col-lg-5"><?php echo e($contact->opening_hours_three); ?></p>
                                <?php endif; ?>
                                <?php if(isset($contact) && $contact->phone_three != null): ?>                                
                                    <p class="mb-0 text-color montserrat-regular font-14 small">
                                        <svg width="13" height="22" viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11 17H2V3H11M6.5 21C6.10218 21 5.72064 20.842 5.43934 20.5607C5.15804 20.2794 5 19.8978 5 19.5C5 19.1022 5.15804 18.7206 5.43934 18.4393C5.72064 18.158 6.10218 18 6.5 18C6.89782 18 7.27936 18.158 7.56066 18.4393C7.84196 18.7206 8 19.1022 8 19.5C8 19.8978 7.84196 20.2794 7.56066 20.5607C7.27936 20.842 6.89782 21 6.5 21ZM10.5 0H2.5C1.83696 0 1.20107 0.263392 0.732233 0.732233C0.263392 1.20107 0 1.83696 0 2.5V19.5C0 20.163 0.263392 20.7989 0.732233 21.2678C1.20107 21.7366 1.83696 22 2.5 22H10.5C11.163 22 11.7989 21.7366 12.2678 21.2678C12.7366 20.7989 13 20.163 13 19.5V2.5C13 1.83696 12.7366 1.20107 12.2678 0.732233C11.7989 0.263392 11.163 0 10.5 0Z" fill="#2F368B"/>
                                        </svg>
            
                                        <?php echo e($contact->phone_three); ?>
            ...
            <div class="row g-4 mt-4">
                ...
                <?php if(isset($contact->maps) && $contact->maps != null): ?>                    
                    <div class="col-lg-4">
                        <div class="ratio ratio-1x1 rounded border overflow-hidden">
                            <iframe
                            src="<?php echo e($contact->maps); ?>"
                            width="100%"
                            height="100%"
                            style="border:0;"
                            allowfullscreen=""
...
<script>
    $(document).ready(function() {
        $('#contactForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("send-contact")); ?>',
                type: 'POST',
                data: formData,
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\sindacsba\resources\views/client/blades/contact.blade.php ENDPATH**/ ?>