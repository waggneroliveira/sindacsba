    ...
    <header id="header" class="w-100 d-flex flex-column position p-0">   
        <div class="w-100 py-2 py-sm-2 header-color">
            <div class="container m-auto d-flex align-items-center justify-content-between flex-row">
                ...
                <div class="social-links d-flex justify-content-start gap-4 text-center col-9">
                    <nav class="site-navigation ul position-relative text-end w-75">
                        <ul class="d-flex flex-row justify-content-start align-items-center gap-3 mb-0 list-unstyled">
                            <li><a href="{{route('index')}}" class="nav-link montserrat-regular font-18 font-extra-light">Notícias</a></li>
                            <li><a href="{{route('noticies')}}" class="nav-link montserrat-regular font-18 font-extra-light">Editais</a></li>
                            <li><a href="{{route('contact')}}" class="nav-link montserrat-regular font-18 font-extra-light">Contato</a></li>
                        </ul>                      
                    </nav>
        ...
        <div class="header--category w-100 grey-medium-background social-links">
            <nav>
                <ul class="d-flex justify-content-center align-items-center mb-0 py-2 gap-3">
    ...
    <div id="menu-mobile" class="menu-mobile d-flex flex-column justify-content-center align-items-center">
        ...
        <nav>
            <ul class="list-unstyled text-center">
                <li><a href="{{route('index')}}" class=" text-white nav-link montserrat-regular font-extra-light font-18">Notícias</a></li>
                <li><a href="{{route('noticies')}}" class=" text-white nav-link montserrat-regular font-extra-light font-18">Editais</a></li>
                <li><a href="{{route('contact')}}" class=" text-white nav-link montserrat-regular font-extra-light font-18">Contato</a></li>
            </ul>
        </nav>
    </div>
        ...
        <div class="container pt-5 pb-3">
            <div class="sitemap mt-2 mb-5 row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 g-3 justify-content-between align-items-center">
                ...
                <ul class="list-unstyled text-start">
                    <li class="montserrat-semiBold mb-2"><a href="{{route('index')}}">Blog</a></li>
                    <li class="montserrat-semiBold mb-2"><a href="{{route('noticies')}}">Editais</a></li>
                    <li class="montserrat-semiBold mb-2"><a href="{{route('contact')}}">Contato</a></li>
                </ul>
                <div class="d-flex justify-content-end flex-column w-auto montserrat-semiBold">
                    <span>
                        <a href="" target=_blank rel="noopener noreferrer" class="d-flex justify-content-start gap-3 align-item-center">
                    ...
                    <span>
                        <a href=https://wa.me/5571996483853 target=_blank rel="noopener noreferrer" class="bg-webmail rounded-3 mt-4 montserrat-regular text-white d-flex justify-content-center align-items-center">
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <div class="text-center"> 
                    <p class="text-start text-white mb-0">Sindicato dos Agentes Comunitários de Saúde (ACS) e <br> Agentes de Combate às Endemias (ACE) <br> CNPJ: 06.953.941/0001-26 </p>                                       
                </div>
                <div class="copyright">
                    <p id="footer-text" class="text-start text-white mb-0"></p>  
                    <script defer>
