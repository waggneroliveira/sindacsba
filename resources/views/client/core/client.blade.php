        ...
        <div class="container py-5">
            <div class="sitemap mt-2 mb-5 row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 g-3 justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-end flex-column w-auto">
                    ...
                    <a href=https://wa.me/5571996483853 target=_blank rel="noopener noreferrer" class="mt-4 rethink-sans-regular ps-5 pe-0 text-white call-to-action d-flex justify-content-between align-items-center">
Fale com a gente!
