    ...
    <section class="contact">
        <div class="d-flex justify-content-start gap-2 align-items-start flex-nowrap">
            ...
            <div class="description">
                <h3 class="fw-bold mb-0 title-blue">FALE CONOSCO</h3>
                <p class="mb-0 text-color">Encontre o nosso endereço, entre em contato via formulário ou através das nossas redes sociais!</p>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="border rounded p-3 h-100">
                        <div class="d-flex gap-2 justify-content-start align-items-center">
                            ...
                            <h6 class="fw-bold mb-2 title-blue">
                                FILIAL 1
                            </h6>
                        </div>
                        <p class="mb-1 small">
                        ...
                        <p class="mb-1 small">De segunda a sexta<br>Das 07:30 às 19:00</p>
                        <p class="mb-0 small">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <form>
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="Whatsapp para contato">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-12 d-flex align-items-center">
                            <div class="form-check me-3">
                                ...
                                <label class="form-check-label small text-color" for="privacyCheck">
                                Aceito os termos descritos na Política de Privacidade
                                </label>
                            </div>
                            <button type="submit" class="btn btn-danger ms-auto px-4">Enviar</button>
                        </div>
                        </div>
                    </form>
                </div>
        ...
        <!-- Redes Sociais -->
        <div class="bg-light py-5 mt-5 d-flex flex-wrap align-items-start justify-content-between socials-network">
            <div class="d-flex justify-content-start gap-2 align-items-start flex-nowrap mt-4">
                <span class="firula-contact mt-2"></span>
                <div class="description">
                    <h3 class="fw-bold mb-0 title-blue">SIGA-NOS NAS REDES SOCIAIS!</h3>
                </div>
            </div>
            <div class="col-6">
