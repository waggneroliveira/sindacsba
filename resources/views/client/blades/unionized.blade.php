            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-7 col-md-6 col-12 mb-4 mb-md-0 d-flex align-items-center gap-5">
                        <img src="{{asset('storage/' . $agreement->path_image)}}" alt="HandShake">
                        <p class="montserrat-semiBold font-25 font-md-20 m-0">
                            {{$agreement->title}}
                        </p>
                    </div>

                    @if ($agreement->path_file <> null )                    
                        <div class="col-lg-4 col-md-5 col-12 text-md-end text-center">
                            <a href="{{asset('storage/' . $agreement->path_file)}}" target="_blank" rel="noopener noreferrer" 
