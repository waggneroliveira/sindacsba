                ...
                @for ($i = 0; $i < 15; $i++)
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 box-notices">                        
                        <div class="section-title rounded-top-left rounded-3 d-flex flex-column justify-content-start align-items-start h-100">
                            <div>
                                <h6 class="mb-1 montserrat-bold font-15 title-blue text-uppercase">LEI nº 11.350/2006</h6>
                                <p class="text-muted text-color montserrat-regular font-15 title-blue">Define as atividades dos ACS e ACE no território nacional. Define as atividades dos ACS e ACE no território nacional.</p>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center w-100">
                                ...
                                <a href="" class="text-decoration-none background-red montserrat-medium font-15 rounded-5 py-2 px-4 text-center d-inline-block w-auto" download="download">
                                    Baixar
