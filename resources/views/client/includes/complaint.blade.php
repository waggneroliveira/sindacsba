@if (!empty($report))
    <section id="complaint" class="complaint my-5">
        <div class="container">
            <div class="background-red m-auto col-12 col-md-9 text-white rounded-4 py-2 px-5 d-flex flex-column flex-md-row align-items-center align-items-md-start gap-5 shadow-sm">
